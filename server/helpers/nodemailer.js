...
module.exports.sendTheMail = (fields) => {
	const mailOptions = {
      ...
      <head>
        ...
        .thumbnail{
          width: 100%;
          background-image: url('https://res.cloudinary.com/xharccoal-com/image/upload/v1647443745/emails/mathyas-kurmann-fb7yNPbT0l8-unsplash_1_xpnrbi.jpg');
          height: 100vw;
          max-width: 500px;
          max-height: 500px;
...
module.exports.newPostEmail = (users) => {
	const mailOptions = {
      ...
      <head>
        ...
        .thumbnail{
          width: 100%;
          background-image: url('https://res.cloudinary.com/xharccoal-com/image/upload/v1647453371/emails/food2_1_tjaxba.jpg');
          height: 100vw;
          max-width: 500px;
          max-height: 500px;
          margin: auto auto auto 0;
...
module.exports.newPasswordEmail = (password) => {
	const mailOptions = {
      ...
      <head>
        ...
        .thumbnail{
          width: 100%;
          background-image: url('https://res.cloudinary.com/xharccoal-com/image/upload/v1647448187/emails/lock_bp8wu4.jpg');
          height: 100vw;
          max-width: 500px;
          max-height: 500px;
          margin: auto auto auto 0;
...
module.exports.newCommentEmail = (name, comment) => {
	const mailOptions = {
      ...
      <head>
        ...
        .thumbnail{
          width: 100%;
          background-image: url('https://res.cloudinary.com/xharccoal-com/image/upload/v1647448168/emails/comment_orm938.jpg');
          height: 100vw;
          max-width: 500px;
          max-height: 500px;
          margin: auto auto auto 0;
...
module.exports.newSubscriberEmail = (email) => {
	const mailOptions = {
      ...
      <head>
        ...
        .thumbnail{
          width: 100%;
          background-image: url('https://res.cloudinary.com/xharccoal-com/image/upload/v1647443805/emails/xharccoal_vkymes.png');
          height: 100vw;
          max-width: 500px;
          max-height: 500px;
          margin: auto auto auto 0;
